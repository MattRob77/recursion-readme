...
At this point, if we asked you to write a function called, sumUpTo(n), you may agree that the definition of the sum up to a number n is equal to us adding together
